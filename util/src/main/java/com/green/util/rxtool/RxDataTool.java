...
import static com.green.util.rxtool.RxConstTool.BYTE;
import static com.green.util.rxtool.RxConstTool.GB;
import static com.green.util.rxtool.RxConstTool.KB;
import static com.green.util.rxtool.RxConstTool.MB;
...
public class RxDataTool {
    ...
    public static String changeDistance(double length, boolean displayMeter) {
        if (length < 1000) {
            ...
            return RxConstants.FORMAT_TWO.format(length / 1000) + (displayMeter ? "千米" : "");
        }
    }
