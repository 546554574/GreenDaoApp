package com.green.util.rxview.cardstack;
...
import com.green.util.rxview.cardstack.tools.RxAdapterAllMoveDownAnimator;
import com.green.util.rxview.cardstack.tools.RxAdapterAnimator;
import com.green.util.rxview.cardstack.tools.RxAdapterStack;
import com.green.util.rxview.cardstack.tools.RxAdapterUpDownAnimator;
import com.green.util.rxview.cardstack.tools.RxAdapterUpDownStackAnimator;
import com.green.util.rxview.cardstack.tools.RxScrollDelegate;
import com.green.util.rxview.cardstack.tools.RxStackScrollDelegateImpl;
...
public class RxCardStackView extends ViewGroup implements RxScrollDelegate {
    ...
    public void clearScrollYAndTranslation() {
        ...
        if (mRxScrollDelegate != null) {
            mRxScrollDelegate.setViewScrollY(0);
        }
        requestLayout();
    }
